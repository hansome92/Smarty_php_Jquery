...
function loadFailed() {
    $('.fallback').removeClass('fallback');
    alert("Something went wrong while loading SWFUpload. You should now see a basic file upload box that you can use.");
}
    ...
    try {
        ...
        switch (errorCode) {
            ...
            case SWFUpload.UPLOAD_ERROR.UPLOAD_STOPPED:
                ...
                break;
            default:
                progress.setStatus("There was an error: " + errorCode);
                this.debug("Error Code: " + errorCode + ", File name: " + file.name + ", File size: " + file.size + ", Message: " + message);
                break;
        }
    } catch (ex) {
