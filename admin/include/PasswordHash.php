...
#
# Version 0.3 / custom version by Eugenio Tacchini, changed strlen, strpos and substr functions to strlen_custom, strpos_custom and substr_custom (look at /include/functions.php to see the new functions
#
...
class PasswordHash {
	...
	function HashPassword($password)
	{
		...
		if (CRYPT_EXT_DES == 1 && !$this->portable_hashes) {
			if (strlen_custom($random) < 3)
				$random = $this->get_random_bytes(3);
			$hash =
			    crypt($password, $this->gensalt_extended($random));
			if (strlen_custom($hash) == 20)
				return $hash;
		}
